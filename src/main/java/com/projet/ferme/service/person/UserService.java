...
public class UserService {
	...
	public Map<String, Object> update(User newUser){
		...
		if(oldUser.isEmpty()) {
			map.put("success", false);
			map.put("message", "l'utilisateur se trouve pas dans la base");
	...
	public Map<String, Object> active(Long id) {
		...
		if(oldUser.isEmpty()) {
			map.put("success", false);
			map.put("message", "l'utilisateur se trouve paa dans la base");
		}else {
	...
	public Map<String, Object> postRole(Role role){
		...
		if(role == null) {
			map.put("success", false);
			map.put("message", "Enregistrement a échoué");
		}else {
			map.put("success", true);
