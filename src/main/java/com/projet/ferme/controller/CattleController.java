...
public class CattleController {
	...
	public Map<String, Object> putCattle(@RequestBody Cattle cattle){
	...
	public Map<String, Object> cattleByEnclosure(@PathVariable("id") Long id){
		return cattleService.cattleByEnclosure(id);
	}
	
	@RequestMapping(value = "/api/v1/category/cattle/{id}", method = RequestMethod.GET)
	public Map<String, Object> cattleByCategory(@PathVariable("id") Long id){
	...
	public Map<String, Object> getOut(@PathVariable("id") Long id){
