...
public class FarmingController {
	...
	public Map<String, Object> speculationByPlantingId(@PathVariable("id") Long id){
		return speculationService.findByPlanting(id);
	}
	
	@RequestMapping(value = "/api/v1/seed/speculation/{id}", method = RequestMethod.GET)
	public Map<String, Object> speculationBySeedId(@PathVariable("id") Long id){
	...
	public Map<String,Object> deleteFarming(@PathVariable("id") Long id) {
	...
	public Map<String, Object> getHavest(@PathVariable("id") Long id){
